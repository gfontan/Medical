...
public class CitasList extends AppCompatActivity {
    ...
    ArrayList<String> dniList, nombreList, apellidosList, razonList, disponibilidadList, fechaList, citasList, medicoList, historialList;
    DbHelperCitas db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ListAdapterCitas(this, dniList, nombreList, apellidosList, razonList, disponibilidadList, fechaList, citasList, medicoList, historialList);
    ...
    private void displayData() {
        ...
        while (cursor.moveToNext()) {
            ...
            fechaList.add(cursor.getString(5));
            citasList.add(cursor.getString(6));
            medicoList.add(cursor.getString(7));
            historialList.add(cursor.getString(8));
        }
